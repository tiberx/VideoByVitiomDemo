...
+(NSString *)diskSizeToHumanString:(unsigned long long)bytes
{
    ...
    long G =(long)( bytes / kBytesPerG);
    long M = (long)((bytes - G * kBytesPerG) / kBytesPerM);
    long K =(long)( (bytes - G * kBytesPerG - M * kBytesPerM) / kBytesPerK);
    long B =(long)( bytes - G * kBytesPerG - M * kBytesPerM - K * kBytesPerK);
