...
-(id)initWithFrame:(CGRect)frame WithPlayUrl:(NSString *)PlayUrl withTitle:(NSString *)VideoTitle withBgImg:(UIImage *)bgImg withShu:(bool)_isFlag withCache:(bool)_isflag2 withImgUrl:(NSString *)ImgUrl{
        ...
        if(bgImg==nil){
          ...
          //  bgImgView.image=[UIImage imageNamed:@"wsmv_default"];
            ...
            if([ImgUrl isEqualToString:@""]||[ImgUrl isEqualToString:@"(null)"]){
                ...
                [ bgImgView setImageWithURL:url refreshCache:NO placeholderImage:[UIImage imageNamed:@"news_list_loading"]];
