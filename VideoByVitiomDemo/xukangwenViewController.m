...
- (void)viewDidLoad
{
    ...
    KKWVideoView *videoView=[[KKWVideoView alloc]initWithFrame:CGRectMake(10, 50, 300, 220) WithPlayUrl:@"http://101.227.173.29/sohu/s26h23eab6/vod/MTAvNjYvOS8atRy8DdkbmFaS3RlSGROclhVOUFNNC5tcDQ9B.mp4" withTitle:@"美食天降" withBgImg:nil withShu:false withCache:true withImgUrl:@"http://www.tuicool.com/images/mobile/index.png"];
